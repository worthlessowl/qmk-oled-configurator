...
$(document).ready(function () {
    ...
    function canvasResize(canvas, context, boundRect, xPix, yPix) {
        canvas.width = xPix * 10;
        canvas.height = yPix * 10;
        context =  canvas.getContext("2d");
        boundRect = canvas.getBoundingClientRect();
    }
    
    function normalizeByTen(val) {
    ...
    e.addEventListener('click', function (event) {
        ...
        elements.forEach(function (ele) {
            if (yVal > ele.top && yVal < ele.height && xVal > ele.left && xVal < ele.width) {
                context.fillRect(normalizeByTen(xVal), normalizeByTen(yVal), 10, 10);
            }
        });
    }, false);
